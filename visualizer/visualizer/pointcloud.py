...
def visualize_pointcloud(pointcloud, idx, color:tuple=None):
    vis = Visualizer()
    # vis.visualize_pointcloud(pointcloud, color=color)
    vis.save_visualization_to_file(pointcloud, "/home/jiahuama/3D-Diffusion-Policy/3D-Diffusion-Policy/output_" + str(idx) + ".html", color=color)
